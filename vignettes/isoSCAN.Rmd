...
* Other columns will be ignored by the function
...
metBarPlot(autoQres=integrations[which(integrations$CompoundName=="Ala"),], 
...
```{r, eval=FALSE}
sum_intg <- sumIsotopologues(integrations)
metBarPlot(autoQres=sum_intg, groups = mygroups, val.to.plot="area")
```
...
rawPlot(SampleFiles=SampleFiles_orbi[1],formulaTable=formulaTable_orbi[1,],RTwin=5)
```
